...
export default function Projects() {
  ...
  const projects = React.useMemo(
    () => [
      {
        title: "Imagine Infotech",
        link: "https://shusanadk562.github.io/imagineinfotech//",
        bgColor: "#37517e",
        image: isMobile ? photo1 : img1, // Mobile vs desktop image
      },
      {
        title: "Quads Games",
        link: "https://shusanadk562.github.io/quads_games.github.io//",
        bgColor: "#101010",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "E-Book",
        link: "https://shusanadk562.github.io/E-book-Store/",
        bgColor: "#e0dfc8",
      ...
      {
        title: "Piooner Hub",
        link: "https://shusanadk562.github.io/Pioneer-HUB/",
        bgColor: "#3861a5",
            ...
            >
              ...
              >
                ...
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full h-full  shadow-2xl drop-shadow-[0_25px_80px_rgba(0,0,0,0.75)] transition-transform duration-300 hover:scale-[1.02]"
                  style={{
                    position: "relative",
                    zIndex: 10,

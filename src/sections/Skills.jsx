...
import {SiTypescript, SiTailwindcss, SiHtml5, SiCss3, SiFigma, SiGit, SiAdobephotoshop, SiAdobeillustrator, SiAdobeindesign,  SiJavascript} from 'react-icons/si';
...
const skills = [
    ...
    { icon: <SiGit/>, name: "Git" },
    { icon: <SiAdobephotoshop />, name: "Adobephotoshop" },
    { icon: <SiAdobeillustrator />, name: "Adobeillustrator" },
    { icon: <SiAdobeindesign />, name: "Adobeindesign" },
  ];

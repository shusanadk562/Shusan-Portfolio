 ...
 */
const socials = [
  { Icon: FaYoutube, label: "YouTube", href: "https://www.youtube.com/@SushanAdhikari-t8k" },
  { Icon: FaXTwitter, label: "X", href: "https://x.com/AdhikariSh67576" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/shusan-adhikari-1264ab2a8/" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/sushan.adhikari.9/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/shusanadk562" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-gray-300 italic max-w-xl">
          “Hard work and readiness create successful outcomes .” 
        </p>

        {/* --- Copyright / Trademark --- */}
        {/* Auto-updates year dynamically */}
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Shusan Adhikari. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
